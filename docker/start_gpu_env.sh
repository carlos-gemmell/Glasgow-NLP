...
docker run --gpus all --name deep_phd_env --rm -p ${2:-8888}:${2:-8888} -v $PWD/../:/my_shared/ deep_phd_env_img jupyter-lab --ip 0.0.0.0 --no-browser --allow-root --notebook-dir="/my_shared"
